...
const cube3 = new THREE.Mesh(geometry3, new THREE.MeshBasicMaterial({ color: debugObject.color, wireframe: true }));
cube3.position.x = 2;
group.add(cube3);
cubeTweaks3
...
cubeTweaks3
    ...
    cube3.geometry = new THREE.BoxGeometry(1, 1, 1, debugObject.subdivision, debugObject.subdivision, debugObject.subdivision);
});
/**
 * Sizes
 */
...
window.addEventListener("dblclick", () => {
    const webkitDoc = document;
    const fullscreenElement = document.fullscreenElement || webkitDoc.webkitFullscreenElement;
